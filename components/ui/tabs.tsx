...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative inline-flex h-fit min-h-10 items-center justify-center whitespace-nowrap rounded-sm px-3 py-2 text-sm font-bold outline-none ring-offset-background transition-all",
