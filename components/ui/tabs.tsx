...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative inline-flex h-fit min-h-10 items-center justify-center whitespace-nowrap px-3 py-2 text-sm font-bold transition-all",
      ...
      "data-[state=active]:before:scale-x-100 [&:not(:disabled)]:hover:before:scale-x-50 [&:not(:disabled)]:focus-visible:before:scale-x-50",
