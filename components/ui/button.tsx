...
const buttonVariants = cva(
  cn(
    "relative inline-flex items-center justify-center whitespace-nowrap gap-1 rounded-2xl text-sm font-medium ring-offset-background transition-colors border",
